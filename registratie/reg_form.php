...
if ($activatie=='2665'){
    mysqli_query($con,"INSERT INTO account(id, username, password, email) VALUES (NULL, '$achternaam', '$password', '$email');");$message = "Account is aangemaakt! druk op OK en je wordt doorgestuurd!";
