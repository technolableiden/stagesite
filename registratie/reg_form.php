...
if ($activatie=='2665'){
    mysqli_query($con,"INSERT INTO account(naam, gbdatum, achternaam, email, mnummer, adres, wplaats, hobby, werk ) VALUES (NULL, '$achternaam', '$gbdatum', '$email', '$mnummer', '$adres', '$wplaats', '$hobby', '$werk');");
